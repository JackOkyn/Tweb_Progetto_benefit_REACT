...
interface Post {
    id: number;
    authorName: string;
    authorImage?: string; // Immagine opzionale
    title: string;
    content: string;
...
const posts: Post[] = [
    ...
    },
    {
        ...
        content: "Ridurre le emissioni di CO2 è fondamentale per limitare il riscaldamento globale. Scopri come puoi contribuire anche tu.",
    },
];
            ...
            <div className="space-y-6">
                {posts.map((post) => {
                    ...
                    return (
                        <div
                            key={post.id}
                            className="bg-gradient-to-br from-blue-50 to-blue-100 shadow-md rounded-lg p-6 flex flex-col space-y-4"
                        >
